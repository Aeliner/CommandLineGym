...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pa_oblig1_2018.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pa_oblig1_2018.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pa_oblig1_2018 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Inscripcion.o: Inscripcion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inscripcion.o Inscripcion.cpp
